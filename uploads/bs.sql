...
-- Records of class
-- ----------------------------
INSERT INTO `class` VALUES ('信息152班', '2015012000');
INSERT INTO `class` VALUES ('信息153班', '2015012000');
INSERT INTO `class` VALUES ('电商151班', '2015012000');
INSERT INTO `class` VALUES ('软工153班', '2015012000');
INSERT INTO `class` VALUES ('软工152班', '31314521441');
...
-- ----------------------------
INSERT INTO `coursetable` VALUES (45, '2015012000', '信息153班', '2019-05-07', '星期二', '14:30:00', '16:20:00', '机房3楼');
INSERT INTO `coursetable` VALUES (48, '2015012000', '电商151班', '2019-05-15', '星期三', '16:30:00', '18:20:00', '机房3楼');
INSERT INTO `coursetable` VALUES (50, '2015012000', '软工153班', '2019-05-13', '星期一', '14:40:00', '16:30:00', '机房3楼');
INSERT INTO `coursetable` VALUES (51, '2015012000', '信息152班', '2019-05-15', '星期三', '14:30:00', '15:50:00', '机房3楼');
INSERT INTO `coursetable` VALUES (52, '2015012000', '信息152班', '2019-05-15', '星期三', '08:00:00', '09:50:00', '机房二层南');
...
CREATE TABLE `stu_experiment_score`  (
  `sno` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `exp1` int(20) NULL DEFAULT NULL,
  `exp2` int(20) NULL DEFAULT NULL,
  `exp3` int(20) NULL DEFAULT NULL,
  `exp4` int(20) NULL DEFAULT NULL,
  `exp5` int(20) NULL DEFAULT NULL,
...
CREATE TABLE `stu_experiment_summary`  (
  ...
  `difficulty` int(255) NULL DEFAULT NULL,
  `summary` tinyblob NULL,
...
-- ----------------------------
INSERT INTO `teacher_experiment` VALUES ('2015012000', '实验1');
INSERT INTO `teacher_experiment` VALUES ('2015012000', '实验2');
INSERT INTO `teacher_experiment` VALUES ('2015012000', '实验3');
